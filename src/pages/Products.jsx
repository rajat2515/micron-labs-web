...
const categories = [
    {
        ...
        products: [
            { name: 'Anashot-P', composition: 'Aceclofenac 100mg + Paracetamol 325mg', form: 'Tablet', use: 'Pain & fever, musculoskeletal pain', price: '₹56 / strip of 10', image: '/products/product-anashot-p.jpg' },
            { name: 'Anashot-SP', composition: 'Aceclofenac 100mg + Paracetamol 325mg + Serratiopeptidase 15mg', form: 'Tablet', use: 'Post-surgical pain, dental pain, sports injuries', price: '₹84 / strip of 10', image: '/products/PHOTO-2026-06-01-15-01-43.jpg' },
            { name: 'Anashot-TC', composition: 'Aceclofenac 100mg + Paracetamol 325mg + Trypsin & Chymotrypsin 150000 Units', form: 'Tablet', use: 'Post-surgical inflammation, soft tissue injuries', price: '₹126.50 / strip of 10', image: '/products/product-anashot-tc.jpg' },
            { name: 'Anashot-XT', composition: 'Trypsin 48mg + Chymotrypsin 8mg + Gingerol 100mg + Curcumin 100mg + Bromelain 90mg + Rutoside Trihydrate 100mg', form: 'Tablet', use: 'Musculoskeletal pain, back pain, arthritis', price: '₹178 / strip of 10', image: '/products/product-anashot-xt.jpg' },
            { name: 'Arrowmin-Spas', composition: 'Mefenamic Acid 250mg + Dicyclomine HCl 10mg', form: 'Tablet', use: 'Abdominal cramps, dysmenorrhoea, spasmodic pain', price: '₹42 / strip of 10', image: '/products/product-arrowmin-spas.jpg' },
            ...
            { name: 'Dicodase-SN', composition: 'Serratiopeptidase 10mg + Diclofenac Potassium 50mg', form: 'Tablet', use: 'Inflammation, post-operative swelling, arthritis', price: '₹65 / strip of 10', image: '/products/PHOTO-2026-06-01-15-45-00.jpg' },
            ...
            { name: 'Drota Care', composition: 'Drotaverine HCl 80mg + Mefenamic Acid 250mg', form: 'Tablet', use: 'Smooth muscle spasms, uterine cramps, renal colic', price: '₹65 / strip of 10', image: '/products/product-drota-care.jpg' },
            { name: 'Drota Care-A', composition: 'Drotaverine HCl 80mg + Aceclofenac 100mg', form: 'Tablet', use: 'Spasmodic pain with inflammation, biliary colic', price: '₹93.50 / strip of 10', image: '/products/product-drota-care-a.jpg' },
            { name: 'ED-60', composition: 'Etoricoxib 60mg', form: 'Tablet', use: 'Acute pain, osteoarthritis, rheumatoid arthritis', price: '₹93.50 / strip of 10', image: '/products/PHOTO-2026-06-01-17-33-15.jpg' },
            { name: 'ED-90', composition: 'Etoricoxib 90mg', form: 'Tablet', use: 'Acute gout, osteoarthritis, rheumatoid arthritis', price: '₹112.50 / strip of 10', image: '/products/PHOTO-2026-06-01-15-43-32.jpg' },
            ...
            { name: 'Bepred-4', composition: 'Methylprednisolone 4mg', form: 'Tablet', use: 'Inflammatory conditions, allergic disorders, rheumatic disorders', price: '₹46.80 / strip of 10', image: '/products/product-bepred-4.jpg' },
            { name: 'Filpcort', composition: 'Deflazacort 6mg', form: 'Tablet', use: 'Inflammatory & allergic conditions, autoimmune disorders', price: '₹93.50 / strip of 10', image: '/products/product-filpcort.jpg' },
            { name: 'Arrowmin-P', composition: 'Mefenamic Acid + Paracetamol', form: 'Suspension', use: 'Fever management in children, body ache', price: '₹48 / bottle', image: '/products/product-arrowmin-p.jpg' },
        ],
    },
    {
        id: 'antibiotics',
        ...
        products: [
            { name: 'Cefbond-LB', composition: 'Cefixime 200mg + Lactic Acid Bacillus Spores', form: 'Tablet', use: 'Bacterial infections with gut protection', price: '₹140 / strip of 10', image: '/products/product-cefbond-lb.jpg' },
            ...
            { name: 'Livorim-500', composition: 'Levofloxacin 500mg', form: 'Tablet', use: 'Community-acquired pneumonia, UTI, sinusitis', price: '₹84 / strip of 10', image: '/products/product-livorim-500.jpg' },
            ...
            { name: 'Microxyl-500', composition: 'Ciprofloxacin 500mg', form: 'Tablet', use: 'UTI, respiratory, GI & skin infections', price: '₹44 / strip of 10', image: '/products/product-microxyl-500.jpg' },
    ...
    },
    {
        ...
        products: [
            ...
            { name: 'Leecare-M', composition: 'Levocetirizine Di-HCl 5mg + Montelukast 5mg', form: 'Tablet', use: 'Allergic rhinitis, urticaria, bronchospasm', price: '₹79.50 / strip of 10', image: '/products/product-leecare-m.jpg' },
            { name: 'Leecare-CF', composition: 'Phenylephrine HCl 5mg + Paracetamol 500mg + Caffeine 30mg + Diphenhydramine HCl 25mg', form: 'Tablet', use: 'Cold, flu, fever with congestion & runny nose', price: '₹51.50 / strip of 10', image: '/products/01e3203a-2bc8-4355-834d-a35ecde146e6.JPG' },
            { name: 'Leecare-CF Syrup', composition: 'Phenylephrine HCl 5mg + Paracetamol 125mg + Sodium Citrate 60mg + Chlorpheniramine Maleate 0.5mg + Menthol 1mg', form: 'Syrup (60ml)', use: 'Paediatric cold, cough & fever with congestion', price: '₹70.30 / 60ml bottle', image: '/products/63bf28ec-2fbb-4a8c-812d-12b788ad7f27.JPG' },
    ...
    },
    {
        ...
        products: [
            ...
            { name: 'Oxychoice (Multivitamin)', composition: 'Lycopene 2mg + Ascorbic Acid 25mg + Nicotinamide 15mg + Vitamins A, B1, B2, B6, B12, D, E + Folic Acid + Zinc + Iron + Magnesium + Selenium + Chromium + Iodine', form: 'Tablet', use: 'General wellness, immunity boost, nutritional gaps', price: '₹80 / strip of 10', image: '/products/product-oxychoice--multivitamin-.jpg' },
    ...
    },
    {
        ...
        products: [
            ...
            { name: 'Okzyme (Tablet)', composition: 'Pancreatin 175mg + Simethicone 50mg + Activated Charcoal 50mg', form: 'Tablet', use: 'Flatulence, bloating, indigestion, malabsorption', price: '₹60.50 / strip of 10', image: '/products/PHOTO-2026-06-01-15-02-04.jpg' },
            ...
            { name: 'Yocid', composition: 'Magaldrate 400mg + Simethicone 20mg', form: 'Suspension (170ml)', use: 'Hyperacidity, peptic ulcer, flatulence', price: '₹79.65 / 170ml bottle', image: '/products/PHOTO-2026-06-01-15-00-52.jpg' },
            ...
            { name: 'Heptalife-Plus', composition: 'L-Ornithine L-Aspartate 150mg + Pancreatin 100mg', form: 'Tablet', use: 'Liver disorders, hepatic encephalopathy, fatty liver', price: '₹93.50 / strip of 10', image: '/products/PHOTO-2026-06-01-15-42-55.jpg' },
    ...
    },
    {
        ...
        products: [
            ...
            { name: 'Fetalife (Tablet)', composition: 'Allylestrenol 5mg', form: 'Tablet', use: 'Threatened miscarriage, recurrent abortion, IVF support', price: '₹117 / strip of 10', image: '/products/product-fetalife--tablet-.jpg' },
            { name: 'Fetalife-500', composition: 'Hydroxyprogesterone 500mg/2ml', form: 'Injection (2ml)', use: 'Prevention of preterm birth, recurrent miscarriage', price: '₹210.90 / vial', image: '/products/ad23924a-ced6-419d-8107-0ceab21d4ab6.JPG' },
            ...
            { name: 'Iro-40 SR', composition: 'Isoxsuprine Hydrochloride 40mg SR', form: 'Tablet', use: 'Preterm labour, threatened abortion, uterine relaxation', price: '₹107.50 / strip of 10', image: '/products/product-iro-40-sr.jpg' },
            ...
            { name: 'Uristrong-KM', composition: 'Potassium Citrate 714.9mg + Magnesium Citrate 263.10mg + D-Mannose 300mg + Cranberry Extract 200mg', form: 'Sachet (10g)', use: 'UTI management, kidney stones, burning micturition', price: '₹311.50 / pack of 10 sachets', image: '/products/product-uristrong-km.jpg' },
            { name: 'Uristrong', composition: 'Shuddha Shilajeet 200mg + Shwet Parpati 150mg + Gokshru 450mg + Punernava 500mg + Pashan Bhed 200mg + Potassium Nitrate 85mg + Green Tea Extract 50mg', form: 'Syrup (100ml)', use: 'UTI, burning micturition, renal calculi, impaired renal function', price: '₹119 / 100ml bottle', image: '/products/PHOTO-2026-06-01-15-03-01.jpg' },
        ],
    },
    {
        id: 'derma',
        ...
        products: [
            ...
            { name: 'Noich Malham', composition: 'Neem Patra + Madhyantrika + Ghrit Kumari + Daru Haldi + Gandhak 500mg + Kapoor 500mg + Salicylic Acid 500mg + Neem Oil + Karanj Oil', form: 'Ointment (100g)', use: 'Fungal skin infections, scabies, eczema, psoriasis', price: '₹234.35 / 100g jar', image: '/products/product-noich-malham.jpg' },
            { name: 'Microdec-25', composition: 'Nandrolone Decanoate 25mg/ml', form: 'Injection (1ml)', use: 'Anemia, muscle wasting, post-surgical recovery', price: '₹65.60 / vial', image: '/products/product-microdec-25.jpg' },
        ],
    },
    {
        id: 'dental',
        ...
        products: [
            { name: 'Cavifree Dental Gel', composition: 'Potassium Nitrate 5% + Sodium Monofluorophosphate 0.7% + Triclosan 0.3%', form: 'Gel (50g)', use: 'Cavity prevention, sensitive teeth, gum protection', price: '₹70.30 / 50g tube', image: '/products/product-cavifree-dental-gel.jpg' },
            { name: 'Cavifree Gumpaint', composition: 'Tannic Acid Glycerin 20% + Iodine 0.3% + Potassium Iodide 0.05% + Menthol 0.5% + Thymol 0.033% + Glycerine 79%', form: 'Gel (15ml)', use: 'Gingivitis, periodontitis, oral ulcers, toothache', price: '₹65.60 / 15ml tube', image: '/products/product-cavifree-gumpaint.jpg' },
        ],
    },
    {
        id: 'cardiovascular',
